...
def downgrade() -> None:
    ...
    op.add_column('bookings', sa.Column('date', postgresql.TIMESTAMP(), autoincrement=False, nullable=False))
    op.add_column('bookings', sa.Column('is_payed', sa.BOOLEAN(), autoincrement=False, nullable=False))
