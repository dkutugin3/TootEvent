...
- city: город проведения мероприятия (строка)
- place: место проведения мероприятия  (строка)
- rating: рейтинг мероприятия  (число от  1 до 10)


Примеры мероприятий:
1. "title": "Macan", "price": 1000, "date": "11.09.2001 09:11", "genre": ["rap"], "rating": 7, "city": Москва, "place": "Лужники", "total_places": 10000
2. "title": "Баста", "price": 1500, "date": "15.10.2023 19:30", "genre": ["classical"], "rating": 9, "city": Петербург, "place": "Концертный зал Чайковского", "total_places": 1000
3. "title": "Obladaet", "price": 3000, "date": "05.07.2023 18:00", "genre": ["rock"], "rating": 8, "city": Москва, "place": "Олимпийский", "total_places": 5000
